<script lang="ts">
	...
	function toggleShowOldPassword() {
		...
		document.getElementById("oldpassword").type = (showOldPassword ? "text" : "password");
		window.getSelection().removeAllRanges();
	}

	function toggleShowNewPassword() {
		showNewPassword = !showNewPassword;
		document.getElementById("newpassword").type = (showNewPassword ? "text" : "password");
		window.getSelection().removeAllRanges();
	}

	function toggleShowConfirmNewPassword() {
		showConfirmNewPassword = !showConfirmNewPassword;
		document.getElementById("confirmNewpassword").type = (showConfirmNewPassword ? "text" : "password");
		window.getSelection().removeAllRanges();
	}
</script>
	...
	>
		<div class="p-6 space-y-4 md:space-y-6 sm:p-8" style="height: 400px;">
			...
			<div style="margin-top: 5px;">
				<Label for="oldpassword" class="block">Old Password
				...
				>
					<svg
						...
						viewBox="0 0 33 33"
						xmlns="http://www.w3.org/2000/svg"
						on:click={toggleShowOldPassword}
					>
						<rect
							class="icon-frame"
							width="32"
						...
						{#if !showOldPassword}
							<g
								transform="translate(6 7) scale(0.035)"
							>
								<path
						...
						{:else}
							<g
								transform="translate(5 7) scale(0.035)"
							>
							<path
			...
			<div style="margin-top: 5px;">
				<Label for="newpassword" class="block">New Password
				...
				>
					<svg
						...
						viewBox="0 0 33 33"
						xmlns="http://www.w3.org/2000/svg"
						on:click={toggleShowNewPassword}
					>
						<rect
							class="icon-frame"
							width="32"
			...
			<div style="margin-top: 5px;">
				<Label for="confirmNewpassword" class="block">Confirm New Password
				...
				>
					<svg
						...
						viewBox="0 0 33 33"
						xmlns="http://www.w3.org/2000/svg"
						on:click={toggleShowConfirmNewPassword}
					>
						<rect
							class="icon-frame"
							width="32"
